...
export default function Playbar() {
  ...
  useEffect(()=>{
    ...
    const handleLoadedMetadata = () => {
        const durationSeconds = audioManager.getDuration();
    ...
    <>
      ...
      <div className="relative border-t border-gray-200 bg-white shadow-md">
        ...
        <div
          ...
          style={{ height: isPlaybarOpen ? "80px" : "0px" }}
        >
                    ...
                    <>
                      <div className="flex items-center">
                        <div
                          ...
                          style={{ background: voice.gradientolors }}
                        />
          ...
          <div className="flex h-full md:hidden">
            ...
            <div className="flex items-center gap-2 px-4">
                <button onClick={togglePlayPause} className="flex h-9 w-9 items-center justify-center rounded-full bg-black text-white">
                  {isPlaying ? (
                    <IoPause className="h-5 w-5" />
                  ) : (
                    <IoPlay className="ml-0.5 h-5 w-5" />
