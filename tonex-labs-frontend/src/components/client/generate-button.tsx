...
export function GenerateButton({
  ...
  return (
    <div
      className={`flex w-full flex-col-reverse items-center gap-4 lg:flex-row lg:justify-between ${className}`}
    >
      {(showCredits ??
      ...
      >
        ...
        <button
          className={`h-9 w-full rounded-lg bg-black px-3 text-sm font-medium whitespace-nowrap text-white ${isDisabled ? "cursor-not-allowed opacity-50" : "hover:bg-gray-800"}`}
          onClick={onGenerate}
