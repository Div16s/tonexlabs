...
if __name__ == "__main__":
    ...
    ref_style = synthesizer.compute_style("Models/LibriTTS/divyankarv.wav")

    # Generate speech
    audio = synthesizer.inference(
        text="Hello, my name is Divyankar and I am now testing with the new fine tune model.",
        ref_s=ref_style,
    )
