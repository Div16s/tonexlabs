...
async def generate_speech(request: GenerateRequest, background_tasks: BackgroundTasks):
    ...
    try:
        ...
        wav_list = gen_wav(sampler,vocoder,prompt=request.prompt,ddim_steps=100,scale=3.0,duration=10,n_samples=1)
        ...
        soundfile.write(local_path,audio,samplerate=SAMPLE_RATE)
